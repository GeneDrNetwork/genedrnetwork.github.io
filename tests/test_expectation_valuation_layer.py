...
class ExpectationValuationLayerTests(unittest.TestCase):
    ...
    def test_ai_radar_uses_beneficiary_expectation_data(self):
        ...
        discovery = build_ai_reasoning_discovery(section, [{
            "company": "NVIDIA", "ticker": "NVDA", "listing_status": "Public",
            "industry": "Semiconductors", "description": "Designs GPU accelerators and accelerated computing platforms.",
        }])
        rows = build_ai_radar(section, [], RUN_AT, expectation_layer(), discovery)
